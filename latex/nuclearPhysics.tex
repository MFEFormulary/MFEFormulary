...
\noindent
Klein-Nishina cross section for Compton scattering \scite{krane}{200}
...
\noindent
Energy shift from Compton scattering \scite{krane}{200}
\fla{ E_{\gamma,f} &= \frac{E_{\gamma,i}}{1+\left(\frac{E_{\gamma,i}}{mc^2}\right)\left(1-\cos\theta\right)} &}

\noindent
Maximum electron recoil energy in Compton Scattering ($\theta = \pi$) \scite{krane}{200}
